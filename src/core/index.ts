...
export default class Option {
   ...
   private readonly splitLine = splitLine
    ...
    * @param {object} option echarts配置项
    */
   initOption(option: { config?: any; seriesItemConfig?: any }): void {
      const { config = {}, seriesItemConfig = {} } = option
   ...
   createOption(singleSeriesOptions: SingleSeries): any {
      ...
      const option = {
         ...
         tooltip: {
            trigger: 'item',
            show: !['line', 'bar'].includes(type),
            ...this.defaultConfig.config.tooltip,
            ...config.tooltip
         },
         xAxis: {
            type: 'category',
         ...
         title: {
            ...this.defaultConfig.config.title,
            ...formattedTitle
         },
         textStyle: {
            ...this.defaultConfig.config.textStyle,
            ...(config.textStyle || {})
         },
         series: [
            {
